public class Assignment {
    public static void main(String[] args) {
        ...
        // In Assignment opperators we assign an opperator with a variable
        // like A = A + 5 so we can see that the value of A is 5 and if we add 5 to it
        // it will be 10 w
        ...
        System.out.println(d /= 2); // It will Divide the variable with 2 
    }
}
