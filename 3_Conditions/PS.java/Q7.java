/**
 * This program takes an integer input from the user representing a day of the week
 ...
 * 
 * Usage:
 * Run the program and enter a number between 1 and 7 to get the corresponding day name.
